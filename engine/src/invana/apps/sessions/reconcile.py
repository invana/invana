"""Reconcile an LLM model proposal into a draft version (docs/for-developers/modules/ask/spec.md).
...
and a validated :class:`~invana.apps.llm.propose.ModelProposal` — referential
