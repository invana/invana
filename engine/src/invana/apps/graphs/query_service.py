"""Shared query-execution core (docs/for-developers/modules/ask/spec.md).
...
docs/for-developers/modules/ask/spec.md removes that standalone route and makes the **sessions message
...
async def resolve_query_language(
    ...
    """The graph's live query language — used to ground NL translation
