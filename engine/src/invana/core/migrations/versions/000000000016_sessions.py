"""Add query sessions tables (docs/for-developers/modules/ask/spec.md).
...
creator — graph delete and user delete hard-CASCADE (docs/for-developers/modules/ask/spec.md).
