"""Canvas version history (docs/for-developers/modules/explore/features/boards.md).
...
def upgrade() -> None:
    op.create_table(
        ...
        # gzipped canvas.exportState() envelope (docs/for-developers/modules/explore/features/boards.md storage
        # optimisation) -
