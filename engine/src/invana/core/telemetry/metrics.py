...
-------
  ...
  llm invana.apps.llm.* LLM provider calls (docs/for-developers/modules/operate/features/observability.md)
  graph invana.query.graph.* Graph query execution, both languages
  (docs/for-developers/modules/operate/features/observability.md)
  message invana.session.message.* Session message round-trips
  (docs/for-developers/modules/operate/features/observability.md)
  gremlin invana.query.gremlin.* LEGACY — superseded by invana.query.graph.*
  (docs/for-developers/modules/operate/features/observability.md)
...
# ── LLM (docs/for-developers/modules/operate/features/observability.md) — provider-call latency & token throughput
# ──────────────────
# Labels: provider, model_id, operation (translate/propose), status, error_type.
# Emitted inline from invana.apps.llm.client (module-level functions can't take the
...
# ── Graph query (docs/for-developers/modules/operate/features/observability.md) — unified across Cypher + Gremlin
# ────────────────────
...
# ── Session message (docs/for-developers/modules/operate/features/observability.md) — end-to-end message round-trips
# ────────────────
...
# ── Gremlin — LEGACY (docs/for-developers/modules/operate/features/observability.md)
# ────────────────────────────────────────────────
