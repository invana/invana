...
def validate_kwargs_for_update_or_search(f):
    def wrapper(self, **kwargs):
        validated_kwargs = _validate_kwargs_for_update_or_search(self, **kwargs)
        result = f(self, **validated_kwargs)
        return _serialize_to_model_datatypes(self, result)
...
def _validate_kwargs_for_update_or_search(self, **properties):
    """
