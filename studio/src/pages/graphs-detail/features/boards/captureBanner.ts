...
// banner (docs/for-developers/modules/explore/features/graph-canvas.md) / a canvas-state thumbnail (docs/for-developers/modules/explore/features/boards.md). Uses the canvas engine's
 ...
 * these small is the main lever on version-history storage (docs/for-developers/modules/explore/features/boards.md).
 */
