import { CAPABILITIES } from "@/pages/graphs-detail/features/ask/assistant/sessionCapabilities";
import {
	Button,
	Dialog,
	DialogContent,
...
/**
 * The session tutorial (docs/for-developers/modules/explore/features/graph-canvas.md): what you can do in a session — query, expand,
