...
export interface SessionContextDisclosureProps {
	...
	prompt?: string;
	/** Fetch the prior turns the model was given (docs/for-developers/modules/ask/spec.md · docs/for-developers/modules/ask/features/reasoning-trace.md). */
...
/**
 * "What the model saw" for an NL reply (docs/for-developers/modules/ask/features/reasoning-trace.md), as a console disclosure under
 * the activity row (docs/for-developers/modules/platform/features/design-system.md). Mounted when the user opens context, so the
