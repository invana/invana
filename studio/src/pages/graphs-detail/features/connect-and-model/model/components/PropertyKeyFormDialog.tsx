/**
 * @deprecated Unreachable — nothing imports it. Its only consumer was `PropertyKeyTable`, which is itself deprecated.
 *
 ...
 * Do not wire it back in; `PropertyEditor` creates the key inline when a property is added to a type.
 */
