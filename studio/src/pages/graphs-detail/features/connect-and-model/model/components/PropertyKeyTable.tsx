 ...
 * Do not wire it back in; a version's keys are added and retyped through `PropertyEditor`, on the type that carries them.
 */

import { useDeletePropertyKeyMutation } from "@/hooks/queries/useModels";
import { PropertyKeyFormDialog } from "@/pages/graphs-detail/features/connect-and-model/model/components/PropertyKeyFormDialog";
