...
import { propertyTypeOptions } from "@/pages/graphs-detail/features/connect-and-model/model/propertyTypes";
...
export function PropertyEditor({
	...
	// Only the property types the bound backend supports for its version (docs/for-developers/modules/graph-connectors/features/capabilities.md).
	...
	async function saveEdit(keyId: string) {
		...
		if (!name) return;
		try {
			// Draft edits stage silently (docs/for-developers/modules/connect-and-model/features/model-editor.md): suppress the per-request toast and
	...
	async function saveAdd() {
		...
		try {
			...
			// type's mappings); both stage silently (docs/for-developers/modules/connect-and-model/features/model-editor.md).
