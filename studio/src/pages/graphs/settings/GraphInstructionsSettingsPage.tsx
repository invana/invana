...
export function GraphInstructionsSettingsPage() {
		...
		<div className="h-full overflow-auto">
			<div className="max-w-3xl mx-auto px-10 py-12">
				...
				<div className="mb-8">
					...
					<h1 className="text-2xl font-bold mt-1">Instructions</h1>
				</div>

				<InstructionsSection username={username} graphSlug={graphSlug} />
			</div>
		</div>
	);
}
