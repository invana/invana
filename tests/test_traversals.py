...
class TestCreateTraversal:
    ...
    def test_vertex_create(self, connector: GremlinConnector):
    ...
    def test_edge_create(self, connector: GremlinConnector):
